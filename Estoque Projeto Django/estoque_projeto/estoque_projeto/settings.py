"""
Django settings for estoque_projeto project.
...
SECRET_KEY = 'django-insecure-q@s@3r3je0_=-w!i)bs!ilsi0%%#0%9leu0db&%5dek^dohcqn'
...
ROOT_URLCONF = 'estoque_projeto.urls'
...
WSGI_APPLICATION = 'estoque_projeto.wsgi.application'
